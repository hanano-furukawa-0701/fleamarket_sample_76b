...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def sending_destination_params
    params.require(:sending_destination).permit(:destination_first_name,:destination_family_name,:destination_first_name_kana,:destination_family_name_kana,:post_code,:prefecture_name,:City,:address,:building_name,:phone_number)
  end
  ...
  protected
  def address_params
    params.require(:sending_destination).permit(:zipcode, :sending_destination)
  end
